...
namespace DataQuery
{
	...
	public class frmDataQuery : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.ToolBarButton tbbExcel;
		...
		private void InitializeComponent()
		{
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmDataQuery));
            ...
            this.tbbExcel = new System.Windows.Forms.ToolBarButton();
            ...
            this.lRYS.Font = new System.Drawing.Font("宋体", 12F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            ...
            // btnOK
            // 
            this.btnOK.Location = new System.Drawing.Point(56, 528);
            ...
            // btnOut
            // 
            this.btnOut.Location = new System.Drawing.Point(72, 608);
            ...
            this.dataGridData.Location = new System.Drawing.Point(176, 42);
            this.dataGridData.Name = "dataGridData";
            this.dataGridData.ReadOnly = true;
            this.dataGridData.Size = new System.Drawing.Size(852, 614);
            this.dataGridData.TabIndex = 4;
            this.dataGridData.Navigate += new System.Windows.Forms.NavigateEventHandler(this.dataGridData_Navigate);
            // 
            // panel1
            // 
            ...
            this.panel1.Size = new System.Drawing.Size(176, 614);
            ...
            // tbbFind
            // 
            this.tbbFind.ImageIndex = 0;
            this.tbbFind.Name = "tbbFind";
            this.tbbFind.Text = "查询";
            // 
            // Separator0
            // 
            ...
            // tbbExcel
            // 
            this.tbbExcel.ImageIndex = 1;
            this.tbbExcel.Name = "tbbExcel";
            this.tbbExcel.Text = "导出";
            // 
            // Separator1
            // 
		...
		{
			_Dtime=System.Convert.ToDateTime(this.dtpTime.Value.ToShortDateString()+" "+this.nud1.Value.ToString()+":00:00");
			_beginTime=_Dtime.AddMinutes(-20);
			_endTime=_Dtime.AddMinutes(20);
			try
			{
				this.ReadConfig();
				strconn.Open();
		...
		private void GateQuery()
		{
			...
			//添加Address
			string sql1=string.Format("select Address from v_GateDatas where StrTime between '{0}' and '{1}' group by address",_beginTime,_endTime);
...
//					+Convert.ToInt32(_dtGate.Rows[t]["TuWater"]);
		...
		private void PumpQuery()
		{
			...
			//添加Address
			string sql1=string.Format("select Address from v_PumpDatasHis where StrTime between '{0}' and '{1}' group by address",_beginTime,_endTime);
			DataSet ds1=new DataSet();
			SqlDataAdapter ada1=new SqlDataAdapter(sql1,strconn);
...
//		}
		...
		private void Form1_Load(object sender, System.EventArgs e)
		{
			...
			string[] showNames1={"位置","时间","闸前水位","闸后水位","提闸高度","流量","剩余水量","总用水量"/*,"昨日总水量",
                                "日用水量"*/};
			int[]  colWiths1={100,120,70,70,70,70,90,100/*,100,100*/};
			...
			string[] showNames2={"位置","时间","流量","效率","剩余水量","昨日总用水量","今日总用水量","日用水量",
									"总输入水量"};
			int[] colWiths2=new int[]{100,120,70,70,100,100,100,100,100};
			...
			string[] showNames3={"位置","时间","流量","效率","剩余水量",/*"昨日剩余水量","日用水量",*/"已用水量",
									"泵站状态"};
			int[] colWiths3=new int[]{100,120,70,70,90,/*90,90,*/100,100};
        ...
        private void dataGridData_Navigate(object sender, NavigateEventArgs ne)
        {
