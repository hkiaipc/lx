...
namespace CommuniServer
{
    ...
    /// 
    /// </summary>
    public class XD2402DeviceFactory
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <param name="address"></param>
        /// <returns></returns>
        static public XD2402Device Create(DeviceDefine dd, string name, int address)
        {
            XD2402Device d = new XD2402Device(dd, name, address);
            return d;
        }
    }
