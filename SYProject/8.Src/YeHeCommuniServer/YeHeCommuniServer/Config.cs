...
namespace CommuniServer
{
    ...
    public class Config: Xdgk.Common.SelfSerializer
    {
        ...
        /// 
        /// </summary>
        public const string ConfigFileName = "SYCSConfig.xml";
        ...
        /// 
        /// </summary>
        public string LXDBConnectionString
        {
            get { return _lxdbConnectionString; }
            set { _lxdbConnectionString = value; }
        } private string _lxdbConnectionString;
